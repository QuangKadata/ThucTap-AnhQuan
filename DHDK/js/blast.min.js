function setColor(a){
    ...
    $(document).ready(function(){$(".blast-box").attr("unselectable","on").css("user-select","none").on("selectstart",!1),
    $(".blast-box .blast-icon").on("click",function(){$(".blast-box").toggleClass("appear-it"),$(this).toggleClass("flip-it")}),
